...
public class Tag23a {
    ...
    int findSolution() {
        ...
        var maxX = elves.values().stream().mapToInt(e-> e.pos.x).max().getAsInt();
        var maxY = elves.values().stream().mapToInt(e-> e.pos.y).max().getAsInt();
        var minX = elves.values().stream().mapToInt(e-> e.pos.x).min().getAsInt();
        var minY = elves.values().stream().mapToInt(e-> e.pos.y).min().getAsInt();

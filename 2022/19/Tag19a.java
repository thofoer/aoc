...
public class Tag19a {
    ...
    public Tag19a(Blueprint blueprint) {
        this.bp = blueprint;
    ...
    private int findGeodeCount(int minLeft, int ore, int clay, int obsidian, int oreRobots, int clayRobots, int obsRobots, int geodeRobots) {
        ...
        var noWait = canBuildOreRobot
                  && canBuildClayRobot
                  && (canBuildObsRobot || clayRobots == 0)
                  && (canBuildGeodeRobot || obsRobots == 0);
    ...
    public static void main(String[] args) throws Exception {
        ...
        var solution = blueprints.stream().map( bp -> bp.id  * new Tag19a(bp).findGeodeCount( 24, 0, 0, 0, 1, 0, 0, 0)).mapToInt(Integer::intValue).sum();
